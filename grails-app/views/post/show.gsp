        ...
        <div class="nav" role="navigation">
          ...
          <span ><sec:ifAnyGranted roles='ROLE_ADMIN'>
            ...
            <fieldset class="buttons">
                <g:link class="btn btn-default" action="edit" resource="${this.post}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
            ...
            <div class="container blogPostShow commentBox">
              <g:formRemote action="saveComment" controller="Comment" name="saveComment" url="[controller:'Comment',action:'saveComment']">
                <div class="col-xs-12">
                  ...
                  <g:textArea name="body" class="col-xs-6" id="commentCreate" placeholder="Leave a public comment..."></g:textArea>
                </div>
                <hr>
                <div class="col-xs-12">
